 ...
 *
 * @file
 * @brief       Internal configuration for LSM6DS3 devices
 *
...
#define LSM6DS3_REG_FUNC_SRC_1              (0x53)
#define LSM6DS3_REG_FUNC_SRC_2              (0x54)
...
#define LSM6DS3_REG_SENS_SYNC_SPI_ERR_CODE  (0x61)
 ...
 * @{
 */
#define LSM6DS3_CTRL_ODR_SHIFT              (4)
#define LSM6DS3_CTRL_ODR_MASK               (0xF0)
#define LSM6DS3_CTRL_FS_SHIFT               (2)
#define LSM6DS3_CTRL_FS_MASK                (0x0C)
 ...
 * @{
 */
#define LSM6DS3_FIFO_CTRL5_CONTINUOUS_MODE  (0x6)
#define LSM6DS3_FIFO_CTRL5_FIFO_ODR_SHIFT   (3)

#define LSM6DS3_FIFO_CTRL3_GYRO_DEC_SHIFT   (3)
/** @} */

/**
 * @brief	Offset for temperature calculation
 */
#define LSM6DS3_TEMP_OFFSET                 (0x1900)

/**
 * @brief 	Reboot wait interval in ms (15ms)
 */
#define LSM6DS3_BOOT_WAIT_MS                (15)
